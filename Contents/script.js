...
var mainWindow, background, surround, switchFacesButton, networkScaleText,
        networkPercentText, tempDigitalCurrText,
        ...
        helpWindow, changePrefs, networkScaleTextArea, networkPercentTextArea,
...
// macintosh
var networkPercentTextAreaxo = 346, networkPercentTextAreayo = 190;   // was 323, 190
var networkScaleTextAreaxo = 536, networkScaleTextAreayo = 383;         // was 513, 383

// windows
var networkPercentTextxo = 346, networkPercentTextyo = 210;           // was 333, 210
...
function sizeClock() {
    ...
    networkPercentTextArea.size = Math.round(23 * scale);
    networkPercentTextArea.hOffset = Math.round(networkPercentTextAreaxo * scale);
    networkPercentTextArea.vOffset = Math.round(networkPercentTextAreayo * scale);
    ...
    networkPercentText.size = Math.round(23 * scale);
    networkPercentText.hOffset = Math.round(networkPercentTextxo * scale);
    networkPercentText.vOffset = Math.round(networkPercentTextyo * scale);
...
function showDigitalValues() {
    networkPercentTextArea.data = cpuMax[sensorCounter] || "00";
    networkPercentText.data = cpuMax[sensorCounter] || "00";
}
//=====================
//End function
//=====================
...
//    print(">>>>>>>>>>>>> traffic.ibps: " + traffic.ibps);
//    print(">>>>>>>>>>>>> traffic.obps: " + traffic.obps);
    ...
    //displayValue(pointer, networkPercentText, whr, invNET, networkSmooth === "enabled", animationInterval);
    ...
    */
    ...
    if (preferences.wirelessSwitch.value === "on") {
        ...
        if (systemAirport.available && systemAirport.powered) {
            ...
            networkPercentText.data = percentageBandwidth;
            networkPercentTextArea.data = percentageBandwidth;
            ...
            networkScaleText.data =  preferences.maxSpeedPref.value;
            networkScaleTextArea.data = preferences.maxSpeedPref.value;

            dangerLamp.opacity = (wirelessStrength + 30) * 2.55;
        } else {
            pointer.rotation = 30;
            pointerShadow.rotation = 30;
            networkPercentText.data = "000";
            networkPercentTextArea.data = "000";
	   ...
	   pointer.rotation = 30;
	   pointerShadow.rotation = 30;
        networkPercentText.data = " 00";
        networkPercentTextArea.data = " 00";
        background.tooltip = " Wireless monitoring is off ";
        dangerLamp.opacity = 0;
    }

    // print(">>>>>>>>>>>>> preferences.actionSwitchPref.value: " + preferences.actionSwitchPref.value);
    ...
    if (percentageBandwidth > 80) {
        dangerLamp.src = "Resources/images/red-lamptrue.png";
    } else {
        dangerLamp.src = "Resources/images/green-lamptrue.png";
    }

    buildVitality(currIcon, String(percentageBandwidth)); // build the dock vitality
}
//=====================
//End function
//=====================
...
function setTextAreas() {
    if (system.platform === "macintosh") {
        ...
        networkPercentTextArea.visible = true;
    } else {
        networkScaleText.visible = true;
        networkPercentText.visible = true;
    }
}
//=====================
//End function
...
/*
    ...
    networkPercentTextArea.tooltip = cpuName[sensorCounter];
    networkPercentText.tooltip = cpuName[sensorCounter];
...
function setNetworkPrefs() {    // was (update)
    ...
    maxBytes = 125000 * preferences.maxSpeedPref.value;
        print(">>>>>>>>>>>>> preferences.maxSpeedPref.value: " + preferences.maxSpeedPref.value);
...
//===============================================================
// this function is called when the widget wakes up after a system sleep
//===============================================================
