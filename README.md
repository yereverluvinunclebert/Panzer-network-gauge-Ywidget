# Panzer-network-gauge-Ywidget

Panzer Network Yahoo Widget, written in Javascript for the Yahoo 
...
incoming/outgoing connections combined. Functional and gorgeous at the same time. 
